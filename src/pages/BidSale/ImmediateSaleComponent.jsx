...
export default function ImmediatePerchaseComponent({
  currentBuyingPrice,
  currentSellingPrice,
}) {
  return (
    <>
      <ConfirmPriceSaleBox>
        <ConfirmPriceTitle>즉시 판매가</ConfirmPriceTitle>
        <InputPriceBox>
          <ConfirmPrice>
      ...
      <Payment>
        ...
        <CalaulateTotalPriceBox>
          <CalaulateTotalPriceTitle>총 정산금액</CalaulateTotalPriceTitle>
          <TotalPrice>{Math.round(currentSellingPrice)}</TotalPrice>
...
const ConfirmPriceSaleBox = styled.div`
  margin-bottom: 10px;
  margin-top: 30px;
  padding: 0 35px;
`;
